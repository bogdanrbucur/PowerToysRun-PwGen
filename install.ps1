...
if (Test-Path "~\AppData\Local\Microsoft\PowerToys\PowerToys Run") {
    ...
    if (Test-Path "~\AppData\Local\Microsoft\PowerToys\PowerToys Run\Plugins\PasswordGenerator") {
        echo "Deleting existing files";
        rm -Recurse "~\AppData\Local\Microsoft\PowerToys\PowerToys Run\Plugins\PasswordGenerator";
    }
    mkdir "~\AppData\Local\Microsoft\PowerToys\PowerToys Run\Plugins\PasswordGenerator";
    
    cp -Recurse "Community.PowerToys.Run.Plugin.PasswordGenerator\bin\x64\Release.*" "~\AppData\Local\Microsoft\PowerToys\PowerToys Run\Plugins\PasswordGenerator";
